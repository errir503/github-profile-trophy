export const COLORS: {[name: string]: Theme} = {
  default: {
    ...
    NEXT_RANK_BAR: "#402C25",
    S_RANK_BASE: "#ED7785",
    S_RANK_SHADOW: "#ED7785",
    S_RANK_TEXT: "#402C25",
    A_RANK_BASE: "#ED7785",
    A_RANK_SHADOW: "#ED7785",
    A_RANK_TEXT: "#402C25",
    B_RANK_BASE: "#ED7785",
    B_RANK_SHADOW: "#ED7785",
    B_RANK_TEXT: "#402C25",
    DEFAULT_RANK_BASE: "#ED7785",
    DEFAULT_RANK_SHADOW: "#ED7785",
    DEFAULT_RANK_TEXT: "#402C25",
  },
  dracula: {
    BACKGROUND: "#282a36",
    TITLE: "#ff79c6",
